...
def kmeans(pointsarray, k, initial_centroids=None, cutoff=.1):
    initial = None
    pointsarray = pointsarray.reshape(-1, 1)
    points = [Point(point) for point in pointsarray]
    # Pick out k random points to use as our initial centroids
    if initial_centroids:
        initial = [Point(find_nearest(pointsarray, i)) for i in initial_centroids]
    else:
